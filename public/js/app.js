	...
	render : function () { 
		...
		return (
			...
			React.createElement("section", null, 
				React.createElement(DropZone, {onNewFile: this.handleNewFile}), 
				React.createElement(FilterableTable, {files: this.state.files, onDeleteFile: this.handleFileDelete})
			)
...
},{"./components/DropZone.jsx":150,"./components/FilterableTable.jsx":154,"object-assign":2,"react":148}],150:[function(require,module,exports){
/** @jsx React.DOM **/
...
var DropZone = React.createClass({displayName: "DropZone",
	...
	render : function () {
		return (
			...
			React.createElement("section", {id: "dragzone", onDragOver: this.handleDragOver, onDragEnd: this.handleDragEnd, onDrop: this.handleDrop, className: "drag-zone"}, 
				React.createElement("p", null, "Drag your files here")
			)
	...
	render : function () {
		return (
			React.createElement("tr", null, 
				React.createElement("td", null, this.props.file.name), 
				React.createElement("td", null, this.props.file.size), 
				React.createElement("td", null, this.props.file.type)
			)
		)
	}
});
...
var FilesTable = React.createClass({displayName: "FilesTable",
	...
	render : function () {
		...
		return (
			...
			React.createElement("table", {id: "fileTable", className: "table table-grid"}, 
...
},{"./FileRow.jsx":151,"react":148}],153:[function(require,module,exports){
/** @jsx React.DOM **/
	...
	render : function () {
		...
		return (
			React.createElement("div", {className: "filter"}, 
				React.createElement("span", null, "Search by name"), 
				React.createElement("input", {ref: "filterTextInput", value: this.props.filterText, onChange: this.handleTextChange, type: "search", placeholder: "Enter file name"})
			)
		);
...
},{"./FilesTable.jsx":152,"./FilterBar.jsx":153,"react":148}]},{},[149,150,151,152,153,154]);
